...
#home
  .home-head
    img.mx-auto(src="~/assets/images/2016/05/derkinzi-back.jpg" :srcset="require('~/assets/images/2016/05/derkinzi-back.jpg').srcSet" sizes="(min-width: 769px) 60vw, 90vw")
  #blogroll
    ul.list-none
      li.mt-10.border-b.border-gray-400.pb-10(class="md:mt-20 md:pb-20" v-for="post in posts" :key="post.attributes.title")
        nuxt-link(:to="post.attributes.slug")
          ...
          img.lazyload.mt-4.rounded.w-full.h-64.object-cover.shadow-lg(:data-src="'~/assets' + post.attributes.feature" :data-srcset="require('~/assets' + post.attributes.feature).srcSet" sizes="(min-width: 769px) 60vw, 90vw" v-if="post.attributes.feature")
